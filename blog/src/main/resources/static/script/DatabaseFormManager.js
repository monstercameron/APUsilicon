    ...
    inputFieldValidator(){
        ...
        for (let index = 0; index < this.fieldList.length; index++) {
            ...
            if(this.fieldList[index].type == "text"){
                ...
                //rules
                for (let ruleIndex = 0; ruleIndex < this.fieldList[index].rules.length; ruleIndex++) {
                    ...
                    if(rules.includes("char")){
                        ...
                        if(charCount == 0 && !nullable){
                            pass = false;
                            inputElem.placeholder += (inputElem.placeholder.includes(" | Can Not Be Empty!")) ? "" :" | Can Not Be Empty!";
                            inputElem.classList.add("is-invalid");
                            console.error("Field Empty")
                        }else if(charCount > ruleCount && !nullable){
                            pass = false;
                            inputElem.value = "";
                            inputElem.placeholder = `${this.fieldList[index].type} | ${charCount}/${ruleCount}, Too Many Chars!`;
                            inputElem.classList.add("is-invalid");
